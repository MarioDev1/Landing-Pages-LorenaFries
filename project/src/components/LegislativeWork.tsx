  ...
  return (
    <section id="legislative-work" className="py-20 bg-primary-200/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Efectos de fondo con logos */}
        <div className="absolute inset-0 bg-gradient-to-br from-accent-100/10 via-transparent to-primary-100/10"></div>
        
        {/* Logo decorativo flotante izquierdo */}
        <div className="absolute left-5 top-1/3 w-64 h-64 opacity-10 -rotate-12 transform hover:rotate-0 
          transition-all duration-1000 hover:opacity-15 hover:scale-110 select-none">
          <img 
            src={logo} 
            alt="" 
        ...
        {/* Logo decorativo flotante derecho */}
        <div className="absolute -right-10 bottom-1/3 w-80 h-80 opacity-10 rotate-12 transform hover:rotate-0 
          transition-all duration-1000 hover:opacity-15 hover:scale-110 select-none">
          <img 
            src={logo} 
            alt="" 
            ...
            >
              ...
              {expandedCard === project.id && (
                ...
                >
                  ...
                  <button
                    onClick={() => handleExternalLinkClick(project.link, project.title)}
